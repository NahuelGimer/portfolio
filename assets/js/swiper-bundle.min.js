...
!(function (e, t) {
	...
	var S = {
		updateSize: function () {
			...
			(t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : a[0].clientWidth),
				(s =
					void 0 !== e.params.height && null !== e.params.height ? e.params.height : a[0].clientHeight),
				(0 === t && e.isHorizontal()) ||
					(0 === s && e.isVertical()) ||
					((t =
	...
	function ie(e, t, s) {
		...
		let r = i.children(`.${a}`);
		return (
			r.length || ((r = d(`<div class="swiper-slide-shadow${s ? `-${s}` : ''}"></div>`)), i.append(r)), r
		);
	}
	...
	const re = [
		...
		function (e) {
			...
			function v() {
				...
				(s[0].style.width = ''),
					...
					(o =
						'auto' === t.params.scrollbar.dragSize ? c * u : parseInt(t.params.scrollbar.dragSize, 10)),
			...
			function b(e) {
				...
				let r;
				(r =
					(w(e) - i.offset()[t.isHorizontal() ? 'left' : 'top'] - (null !== l ? l : o / 2)) / (c - o)),
		...
		function (e) {
			...
			function o() {
				return (
					void 0 === t && !s.autoplay.running && ((s.autoplay.running = !0), n('autoplayStart'), l(), !0)
				);
			}
			function d() {
				return (
